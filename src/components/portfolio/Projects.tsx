...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Customer relationship management platform built for an energy company to streamline client operations",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&h=400",
      technologies: ["React", "Node.js", "MongoDB", "Tailwind CSS"],
      details: "Designed and developed a full-featured CRM platform tailored for Gambus Energy, enabling the team to manage client records, track interactions, and monitor sales pipelines. Built a responsive frontend with React and Tailwind CSS, backed by a Node.js/MongoDB API, with role-based access control and real-time dashboard analytics.",
